...
import PropertyQuickSearch from "../components/PropertyQuickSearch";
...
export default function Home() {
  const [activeTab, setActiveTab] = useState<"property" | "permit">("property");
  ...
  const handleZipcodeSearch = () => {
    ...
    if (county) {
      ...
      const result: CountyData = {
        ...
        taxBillUrl: countyInfo.taxBillUrl,
      };
      setResult(result);
      setError("");
    } else {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              Streamline your property research and permit lookup workflow
            </p>
          </div>

          {/* Tab Navigation */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-1 mb-8">
          ...
          {activeTab === "permit" && (
            <div className="mb-8">
              {/* State Selection */}
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl shadow-xl p-8 mb-8 border border-green-200 dark:border-green-800">
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-2">
                    Select Your State
                  </h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Choose your state to find permit information
                  </p>
                </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl shadow-xl p-8 mb-8 border border-green-200 dark:border-green-800">
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Get specific permit information for your location
                  </p>
                </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="pt-4 space-y-3">
                          <a
                            ...
                            className="mr-2 inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 font-medium"
                          >
